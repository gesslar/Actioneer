...
1. **Polish the JSDoc in your JS sources.** That’s what `tsc --allowJs` consumes when it builds the declarations. The tighter the annotations, the better the emitted `.d.ts`.
